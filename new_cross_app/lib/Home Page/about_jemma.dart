...
import 'package:new_cross_app/Home%20Page/adaptive.dart';
import 'package:new_cross_app/Home%20Page/decorations.dart';
import 'package:new_cross_app/Home%20Page/responsive.dart';
import 'package:new_cross_app/Home%20Page/jemma_logo.dart';
...
class AboutJemma extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Replace Sizer method .pw() and .ph() with MediaQuery percentage calculation
    double pw(double percent) => size.width * percent / 100;
    double ph(double percent) => size.height * percent / 100;

    return Container(
      padding: EdgeInsets.symmetric(horizontal: pw(5), vertical: pw(1)),
