    ...
    return  Scaffold(
      ...
      body:Consumer<BookingsNotifier>(
          builder: (context,bookingsNotifier,child) {
            ...
            else if(!bookingsNotifier.hasFetchedInitialData || bookingsNotifier.isLoading ){
                ...
                if(bookingsNotifier.searchQuery?.isNotEmpty ?? false)
                  SliverToBoxAdapter(child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Flexible(child: Text("Search results for ${bookingsNotifier.searchQuery}",
                        ...
                        children: [
                          for (var status in BookingsNotifier.statuses)
                            ChoiceChip(
                              ...
                              label: Text(status),
                              selected: BookingsNotifier.selectedBookingStatus == status ,
