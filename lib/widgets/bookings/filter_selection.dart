...
class _FilterSelectionState extends State<FilterSelection> {
 SortField? initialSortField;
  ...
  late String _selectedSortField = initialSortField?.field ?? BookingsNotifier.sortingFields.first;
        ...
        child: Column(
          children: [
            ...
            Wrap(
                ...
                spacing: 10,
                children:[
                  for(var sortingField in BookingsNotifier.sortingFields)
                    ChoiceChip(
                        elevation: 2,
                        label:Text(sortingField.toSortFieldStyledString()),
                        onSelected: (_){ setState(() {
                          _selectedSortField = sortingField;
                          if(sortingField == BookingsNotifier.sortingFields.first){
            ...
            Wrap(
                ...
                children:[
                  ...
                  ,onSelected: (_){
                    if(_selectedSortField.isNotEmpty && _selectedSortField!=BookingsNotifier.sortingFields.first) {
                        setState(() {
